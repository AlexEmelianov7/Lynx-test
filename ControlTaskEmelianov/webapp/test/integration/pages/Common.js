sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskEmelianov/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskEmelianov.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskEmelianov/localService/mockserver"], function (mockserver) {
